...
public class LemonContext implements LemonCallback {
    ...
    public final static String APP_PATH_KEY = "X-Lemon-Application";
    public final static String CONTEXT_PATH_KEY = "X-Lemon-ContextPath";
    public final static String PATH_KEY = "X-Lemon-Path";
    public final static String METHOD_KEY = "X-Lemon-Method";
    ...
    public final static String CLIENT_HOST_KEY = "X-Lemon-Host";
